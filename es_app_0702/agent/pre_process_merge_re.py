...
if __name__ =="__main__":
    ...
    file_path = '/root/web_demo/HybirdSearch/cmx_workapace/es_app_0625_index_type/unprocessed/RankRAG Unifying Context Ranking with.pdf.json'
    file_name = 'RankRAG Unifying Context Ranking with'   # 别带.pdf
    dp = KnowledgeDocumentPreprocessor(tokenizer_path,  file_path, file_name)
    knowledge, long_content = dp.process()
    
    with open('/root/web_demo/HybirdSearch/cmx_workapace/es_app_0625_index_type/问答_processed/RankRAG Unifying Context Ranking with.json', 'w', encoding='utf-8') as f:
        json.dump(knowledge, f, ensure_ascii=False, indent=4)
    with open('/root/web_demo/HybirdSearch/cmx_workapace/es_app_0625_index_type/长文本_processed/RankRAG Unifying Context Ranking with.json', 'w', encoding='utf-8') as f:
