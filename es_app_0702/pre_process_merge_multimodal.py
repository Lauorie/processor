...
class KnowledgeDocumentPreprocessor:
    ...
    def __init__(self,tokenizer_path, file_path, file_name):
        ...
        self.intern = Intern("/root/web_demo/HybirdSearch/models/InternVL-Chat-V1-5")
    ...
    def preprocess(self):
        ...
        for chunk in self.data:
            ...
            if chunk['type'] == 'IMAGE':
                ...
                base64_string = chunk['base64']
                text = self.intern.describe(base64_string)
                chunk['text'] = text
    ...
    def process(self):
        ...
        for chunk_list in chunk_knowledge_list:
            for chunk in chunk_list:
                if chunk['type']!='TITLE':
                    chunk['base64_list'] = chunk.pop('base64')
                    chunk['text_list'] = chunk.pop('texts')
